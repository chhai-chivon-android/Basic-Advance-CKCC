...
public class StaggerGridAdapter extends RecyclerView.Adapter<StaggerGridAdapter.ViewHolder> {
  ...
  public StaggerGridAdapter(List<FeedModel> feeds){
    this.feeds = feeds;
  }

  @Override public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_demo_recyclerview_pinterest,parent,false);
