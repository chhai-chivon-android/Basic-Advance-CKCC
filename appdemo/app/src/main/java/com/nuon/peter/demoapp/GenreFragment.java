...
public class GenreFragment extends Fragment {
  ...
  private GenrePagerFragmentAdapter adapter;
  ...
  @Override public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
    ...
    title.setText("Genre");
    MovieFragment.mCurrentMenuCategory = getGenres().get(0).cateid;
    adapter = new GenrePagerFragmentAdapter(getFragmentManager(),getGenres());
    ...
    pager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
      ...
      @Override public void onPageSelected(int position) {
        fragment = (MovieFragment) adapter.getItem(position);
        fragment.onPageSelected(position,getGenres().get(position).cateid);
      }
