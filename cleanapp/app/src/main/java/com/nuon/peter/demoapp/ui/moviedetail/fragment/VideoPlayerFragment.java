...
import com.nuon.peter.demoapp.base.component.subs.Caption;
import com.nuon.peter.demoapp.base.fragments.BaseVideoPlayerFragment;
import com.nuon.peter.demoapp.utils.AnimUtils;
import com.nuon.peter.demoapp.utils.FragmentUtil;
import com.nuon.peter.demoapp.utils.LocaleUtils;
import com.nuon.peter.demoapp.utils.PixelUtils;
import com.nuon.peter.demoapp.utils.PrefUtils;
import com.nuon.peter.demoapp.utils.StringUtils;
import com.nuon.peter.demoapp.utils.VersionUtils;
import com.nuon.peter.demoapp.utils.views.custom.StrokedRobotoTextView;
...
public class VideoPlayerFragment extends BaseVideoPlayerFragment implements View.OnSystemUiVisibilityChangeListener {
    ...
    @BindView(R.id.control_bar) com.nuon.peter.demoapp.utils.views.custom.SeekBar mControlBar;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable
        ...
        return inflater.inflate(R.layout.layout_fragment_video_player, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mSubtitleText.setTextSize(
            TypedValue.COMPLEX_UNIT_DIP, PrefUtils.get(getActivity(), Prefs.SUBTITLE_SIZE, 16));
        mSubtitleText.setStrokeColor(PrefUtils.get(getActivity(), Prefs.SUBTITLE_STROKE_COLOR, Color.BLACK));
        mSubtitleText.setStrokeWidth(
            TypedValue.COMPLEX_UNIT_DIP, PrefUtils.get(getActivity(), Prefs.SUBTITLE_STROKE_WIDTH, 2));
