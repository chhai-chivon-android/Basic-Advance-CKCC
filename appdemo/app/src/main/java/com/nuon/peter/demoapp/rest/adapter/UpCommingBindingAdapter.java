...
public class UpCommingBindingAdapter extends RecyclerView.Adapter<UpCommingBindingAdapter.ViewHolder> {

  private List<ResultsItem> moviesItems = new LinkedList<>();
  private MovieDetailView view;

  public UpCommingBindingAdapter( MovieDetailView view){
    this.view = view;
  }

  @Override public UpCommingBindingAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    return new UpCommingBindingAdapter.ViewHolder(bind);
  }

  @Override public void onBindViewHolder(UpCommingBindingAdapter.ViewHolder holder, final int position) {
