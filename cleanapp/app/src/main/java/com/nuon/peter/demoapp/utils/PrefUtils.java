...
import com.nuon.peter.demoapp.base.component.content.ObscuredSharedPreferences;
...
public class PrefUtils {
    ...
    public static ObscuredSharedPreferences getPrefs(Context context) {
        return new ObscuredSharedPreferences(context, context.getSharedPreferences(Common.PREFS_FILE, Context.MODE_PRIVATE));
    }
