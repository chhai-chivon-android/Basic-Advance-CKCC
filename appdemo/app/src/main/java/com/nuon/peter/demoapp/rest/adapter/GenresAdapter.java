...
public class GenresAdapter extends RecyclerView.Adapter<GenresAdapter.ViewHolder> {
  ...
  public GenresAdapter(Context context, MovieDetailView view){
    this.context = context;
    this.view = view;
  }

  @Override public GenresAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_rest_fragment_recycler_item,parent,false);
    return new GenresAdapter.ViewHolder(view);
  }

  @Override public void onBindViewHolder(GenresAdapter.ViewHolder holder, final int position) {
