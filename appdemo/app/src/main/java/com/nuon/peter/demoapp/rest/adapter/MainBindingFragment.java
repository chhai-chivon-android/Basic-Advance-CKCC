...
public class MainBindingFragment extends Fragment implements MovieDetailView {
    ...
    private MainBindingMovieAdapter adapter;
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new MainBindingMovieAdapter(this);
