...
public class HomeRestMovieAdapter extends RecyclerView.Adapter<HomeRestMovieAdapter.ViewHolder> {

  private List<ResultsItem> moviesItems = new LinkedList<>();
  private Context context;
  private MovieDetailView view;

  public HomeRestMovieAdapter(Context context, MovieDetailView view){
