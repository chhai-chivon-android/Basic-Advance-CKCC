...
public class UpCommingAdapter extends RecyclerView.Adapter<UpCommingAdapter.ViewHolder> {
  ...
  public UpCommingAdapter(Context context, MovieDetailView view){
  ...
  @Override public void onBindViewHolder(UpCommingAdapter.ViewHolder holder, final int position) {
