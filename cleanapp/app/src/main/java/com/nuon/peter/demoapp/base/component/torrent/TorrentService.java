...
import com.nuon.peter.demoapp.base.activities.TorrentActivity;
import com.nuon.peter.demoapp.base.component.content.preferences.Prefs;
import com.nuon.peter.demoapp.base.component.forground.Foreground;
...
public class TorrentService extends Service implements TorrentListener {
    ...
    public void onCreate() {
        ...
        options.setSaveLocation(PrefUtils.get(this, Prefs.STORAGE_LOCATION, App.getStreamDir()));
    ...
    public void startForeground() {
        ...
        NotificationCompat.Action stopAction = new NotificationCompat.Action.Builder(R.drawable.ic_close_cross, getString(R.string.stop), pendingStopIntent).build();
