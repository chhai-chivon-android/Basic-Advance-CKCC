...
public class PopularityBindingAdapter extends RecyclerView.Adapter<PopularityBindingAdapter.ViewHolder> {

  private List<ResultsItem> moviesItems = new LinkedList<>();
  private MovieDetailView view;

  public PopularityBindingAdapter(MovieDetailView view){
    this.view = view;
  }

  @Override public PopularityBindingAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    return new PopularityBindingAdapter.ViewHolder(bind);
  }

  @Override public void onBindViewHolder(PopularityBindingAdapter.ViewHolder holder, final int position) {
