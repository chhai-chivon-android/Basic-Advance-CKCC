...
import com.nuon.peter.demoapp.rest.adapter.GenresFragmentPagerAdapter;
...
public class GenresRestFragment extends Fragment{
  private TabLayout tab;
  private ViewPager pager;
  private TextView title;
  private GenresFragmentPagerAdapter adapter;

  @Nullable @Override
  public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
      @Nullable Bundle savedInstanceState) {
    View view = inflater.inflate(R.layout.layout_fragment_genre_rest,container,false);
  ...
  @Override public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
    ...
    adapter = new GenresFragmentPagerAdapter(getFragmentManager(),getGenres());
