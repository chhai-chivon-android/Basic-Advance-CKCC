...
public class ActorBindingAdapter extends RecyclerView.Adapter<ActorBindingAdapter.ViewHolder> {

  private Context context;
  private List<CrewItem> moviesItems = new LinkedList<>();

  public ActorBindingAdapter(Context context){
    this.context = context;
  }

  @Override public ActorBindingAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_activity_detail_actor_items,parent,false);
    return new ActorBindingAdapter.ViewHolder(view);
  }

  @Override public void onBindViewHolder(ActorBindingAdapter.ViewHolder holder, int position) {
