...
public class UpCommingInteractorImpl implements UpCommingInteractor {

  private BaseMultiLoadedListener<ResponseMovies> listener;

  public UpCommingInteractorImpl(BaseMultiLoadedListener<ResponseMovies> listener) {
    this.listener = listener;
  }

  @Override public void requestData(int page, final int which) {
    Call<ResponseMovies> call = MovieListAPI.getMovieListManager().getUpComing(page);
