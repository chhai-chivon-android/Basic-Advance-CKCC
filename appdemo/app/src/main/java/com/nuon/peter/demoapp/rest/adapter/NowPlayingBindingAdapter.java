...
public class NowPlayingBindingAdapter extends RecyclerView.Adapter<NowPlayingBindingAdapter.ViewHolder> {

  private List<ResultsItem> moviesItems = new LinkedList<>();

  private MovieDetailView view;

  public NowPlayingBindingAdapter(MovieDetailView view){
    this.view = view;
  }
