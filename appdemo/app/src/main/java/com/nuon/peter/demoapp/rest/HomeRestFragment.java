...
public class HomeRestFragment extends Fragment implements MovieDetailView {
    ...
    private HomeRestMovieAdapter adapter;
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new HomeRestMovieAdapter(view.getContext(),this);
