...
public class RatingAdapter extends RecyclerView.Adapter<RatingAdapter.ViewHolder> {
  ...
  public RatingAdapter(Context context, MovieDetailView view){
    this.context = context;
    this.view = view;
  }

  @Override public RatingAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
  ...
  @Override public void onBindViewHolder(RatingAdapter.ViewHolder holder, final int position) {
